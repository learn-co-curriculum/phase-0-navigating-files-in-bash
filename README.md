...
try running `ls` (the first character is a lowercase letter L). The command
`ls` stands for "**l**i**s**t". After you run it, you should then see a list
of all the files within your working directory. 
